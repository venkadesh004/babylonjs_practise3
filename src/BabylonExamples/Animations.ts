import {AbstractMesh, CubeTexture, Engine, FreeCamera, Mesh, Scene, SceneLoader, Vector3, Animation} from "@babylonjs/core";
...
export class Animations {
    ...
    CreateAnimation(): void {
        ...
        const animControl = this.scene.beginDirectAnimation(this.target, [slideAnim, rotateAnim], 0, 180, true, 1, onAnimationEnd);
