import { Scene, Engine, SceneLoader, CubeTexture, FreeCamera, Vector3, CannonJSPlugin, MeshBlock, MeshBuilder, PhysicsImpostor } from "@babylonjs/core";
...
export class PhysicsVelocity {
  ...
  async CreateRocket(): Promise<void> {
    ...
    meshes[0].setParent(rocketCol); // It handles the origin
